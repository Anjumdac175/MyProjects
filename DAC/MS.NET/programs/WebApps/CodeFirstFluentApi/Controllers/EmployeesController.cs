...
namespace CodeFirstFluentApi.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var empDbContext = _context.Employees.Include(e => e.DeptNoNavigation);
            return View(await empDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("EmpNo,EmpName,Basic,DeptNo")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpNo,EmpName,Basic,DeptNo")] Employee employee)
        {
